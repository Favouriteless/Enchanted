...
public class ImageFrameBuilder extends PageComponentBuilder {

    public static final ResourceLocation ID = EPageComponents.ID_IMAGE_FRAME;

    protected ImageFrameBuilder() {
        super(ID);
    }

    public static ImageFrameBuilder of() {
