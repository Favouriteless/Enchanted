...
public class SpinningBuilder extends PageComponentBuilder {

    public static final ResourceLocation ID = EPageComponents.ID_SPINNING;

    protected SpinningBuilder() {
        super(ID);
    }

    public static SpinningBuilder of() {
        return new SpinningBuilder();
    }
