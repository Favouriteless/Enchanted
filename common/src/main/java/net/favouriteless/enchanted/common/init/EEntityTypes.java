...
public class EEntityTypes {
    ...
    public static final Supplier<EntityType<Broomstick>> BROOMSTICK = register(
            "broomstick", () -> Builder.of(Broomstick::new, MobCategory.MISC)
    ...
    public static final Supplier<EntityType<FamiliarCat>> FAMILIAR_CAT = register(
            "familiar_cat", () -> Builder.of(FamiliarCat::new, MobCategory.CREATURE)
                                         .sized(0.6F, 0.7F).clientTrackingRange(8).build(Enchanted.id("familiar_cat").toString())
    );

    public static final Supplier<EntityType<Mandrake>> MANDRAKE = register(
            "mandrake", () -> Builder.of(Mandrake::new, MobCategory.MONSTER)
                                     .sized(0.4F, 0.7F).build(Enchanted.id("mandrake").toString())
    );

    public static final Supplier<EntityType<ThrowableBrew>> THROWABLE_BREW = register(
            "throwable_brew", () -> Builder.of(ThrowableBrew::new, MobCategory.MISC)
                                           .sized(0.25F, 0.25F).clientTrackingRange(4).updateInterval(10).build(Enchanted.id("throwable_brew").toString())
    );

    public static final Supplier<EntityType<VoodooItemEntity>> VOODOO_ITEM = register(
            "voodoo_item", () -> Builder.of(VoodooItemEntity::new, MobCategory.MISC)
