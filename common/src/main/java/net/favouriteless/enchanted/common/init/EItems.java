...
public class EItems {
	...
	public static final Supplier<Item> EARTH_POPPET_INFUSED = register("infused_earth_poppet", () -> new DeathPoppetEffectItem(0.0F, PoppetColour.EARTH, () -> new MobEffectInstance(EMobEffects.FALL_RESISTANCE, 200), source -> source.is(DamageTypeTags.IS_FALL) || source.is(DamageTypes.FLY_INTO_WALL), poppetProps(1)));
	...
	public static final Supplier<DeathPoppetItem> MAGIC_POPPET = register("magic_poppet", () -> new DeathPoppetItem(0.3F, PoppetColour.MAGIC, EMobEffects::isMagic, poppetProps(1)));
	public static final Supplier<DeathPoppetEffectItem> MAGIC_POPPET_INFUSED = register("infused_magic_poppet", () -> new DeathPoppetEffectItem( 0.0F, PoppetColour.MAGIC, () -> new MobEffectInstance(EMobEffects.MAGIC_RESISTANCE, 200), EMobEffects::isMagic, poppetProps(1)));
	public static final Supplier<DeathPoppetItem> MAGIC_POPPET_STURDY = register("sturdy_magic_poppet", () -> new DeathPoppetItem( 0.0F, PoppetColour.MAGIC, EMobEffects::isMagic, poppetProps(2)));
	...
	public static final Supplier<Item> MUTANDIS = register("mutandis", () -> new MutandisItem(ETags.Blocks.MUTANDIS, ETags.Blocks.MUTANDIS_BLACKLIST));
	public static final Supplier<Item> MUTANDIS_EXTREMIS = register("mutandis_extremis", () -> new MutandisItem(ETags.Blocks.MUTANDIS_EXTREMIS, Blocks.MUTANDIS_EXTREMIS_BLACKLIST));
	...
	public static final Supplier<Item> VOID_POPPET_INFUSED = register("infused_void_poppet", () -> new VoidPoppetEffectItem( 0.0F, PoppetColour.VOID, () -> new MobEffectInstance(EMobEffects.FALL_RESISTANCE, 150), source -> source.is(DamageTypes.FELL_OUT_OF_WORLD), poppetProps(1)));
	...
	public static final Supplier<DeathPoppetEffectItem> WATER_POPPET = register("water_poppet", () -> new DeathPoppetEffectItem(0.3F, PoppetColour.WATER, () -> new MobEffectInstance(EMobEffects.DROWN_RESISTANCE, 100), source -> source.is(DamageTypeTags.IS_DROWNING), poppetProps(1)));
	...
	public static final Supplier<DeathPoppetEffectItem> WATER_POPPET_STURDY = register("sturdy_water_poppet", () -> new DeathPoppetEffectItem( 0.0F, PoppetColour.WATER, () -> new MobEffectInstance(EMobEffects.DROWN_RESISTANCE, 100), source -> source.is(DamageTypeTags.IS_DROWNING), poppetProps(2)));
