...
public class DistilleryMenu extends ContainerMenuBase<DistilleryBlockEntity> {
    ...
    public DistilleryMenu(int id, Inventory playerInventory, DistilleryBlockEntity be, ContainerData data) {
        super(EMenuTypes.DISTILLERY.get(), id, be, EBlocks.DISTILLERY.get());
        this.data = data;
    ...
    public DistilleryMenu(int id, Inventory playerInventory, BlockPos pos) {
        this(id, playerInventory, MenuUtils.getBlockEntity(playerInventory, pos, DistilleryBlockEntity.class), new SimpleContainerData(2));
    }
