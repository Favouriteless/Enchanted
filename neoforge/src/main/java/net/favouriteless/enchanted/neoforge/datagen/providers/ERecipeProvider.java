...
import net.favouriteless.enchanted.api.datagen.builders.recipe.KettleRecipeBuilder;
...
public class ERecipeProvider extends RecipeProvider {
    ...
    protected void buildShapedRecipes(RecipeOutput output, Provider registries) {
        ...
        EShapedRecipeBuilder.shaped(RecipeCategory.MISC, EItems.KETTLE.get())
                            ...
                            .define('c', Items.CAULDRON).save(output);
    ...
    protected void buildSpinningRecipes(RecipeOutput output, Provider registries) {
        // Basic poppets
        spinning(
                output, EItems.POPPET_INFUSED.get(),
                EItems.POPPET.get(), EItems.ATTUNED_STONE.get(), Items.ENDER_PEARL
        );
        spinning(
                output, EItems.POPPET_STURDY.get(),
                EItems.POPPET.get(), EItems.HINT_OF_REBIRTH.get(), Items.SHIELD
        );
        // Effect poppets
        spinningSet(
                output, EItems.ARMOUR_POPPET.get(), EItems.ARMOUR_POPPET_INFUSED.get(), EItems.ARMOUR_POPPET_STURDY.get(),
                EItems.HINT_OF_REBIRTH.get(), Items.DIAMOND_BOOTS
        );
        spinningSet(
                output, EItems.EARTH_POPPET.get(), EItems.EARTH_POPPET_INFUSED.get(), EItems.EARTH_POPPET_STURDY.get(),
                new ItemStack(EItems.MANDRAKE_ROOT.get()), PotionContents.createItemStack(Items.POTION, Potions.LONG_SLOW_FALLING)
        );
        spinningSet(
                output, EItems.FIRE_POPPET.get(), EItems.FIRE_POPPET_INFUSED.get(), EItems.FIRE_POPPET_STURDY.get(),
                new ItemStack(EItems.EMBER_MOSS.get()), PotionContents.createItemStack(Items.POTION, Potions.LONG_FIRE_RESISTANCE)
        );
        spinningSet(
                output, EItems.HUNGER_POPPET.get(), EItems.HUNGER_POPPET_INFUSED.get(), EItems.HUNGER_POPPET_STURDY.get(),
                EItems.ROWAN_BERRIES.get(), Items.ROTTEN_FLESH
        );
        spinningSet(
                output, EItems.TOOL_POPPET.get(), EItems.TOOL_POPPET_INFUSED.get(), EItems.TOOL_POPPET_STURDY.get(),
                EItems.HINT_OF_REBIRTH.get(), Items.DIAMOND_SWORD
        );
        spinningSet(
                output, EItems.VOID_POPPET.get(), EItems.VOID_POPPET_INFUSED.get(), EItems.VOID_POPPET_STURDY.get(),
                EItems.OTHERWHERE_CHALK.get(), EItems.ENDER_DEW.get()
        );
        spinningSet(
                output, EItems.WATER_POPPET.get(), EItems.WATER_POPPET_INFUSED.get(), EItems.WATER_POPPET_STURDY.get(),
                new ItemStack(EItems.WATER_ARTICHOKE.get()), PotionContents.createItemStack(Items.POTION, Potions.LONG_WATER_BREATHING)
        );
        spinningSet(
                output, EItems.MAGIC_POPPET.get(), EItems.MAGIC_POPPET_INFUSED.get(), EItems.MAGIC_POPPET_STURDY.get(),
                new ItemStack(EItems.ANOINTING_PASTE.get()), PotionContents.createItemStack(Items.POTION, Potions.STRONG_HARMING)
        );
        spinningSet(
                output, EItems.VOODOO_PROTECTION_POPPET.get(), EItems.VOODOO_PROTECTION_POPPET_INFUSED.get(), EItems.VOODOO_PROTECTION_POPPET_STURDY.get(),
    ...
    protected void buildKettleRecipes(RecipeOutput output, Provider registries) {
        KettleRecipeBuilder.of(new ItemStack(EItems.BREW_OF_LOVE.get(), 3), 0)
                           .inputs(
                                   Items.POPPY, Items.GOLDEN_CARROT, Items.LILY_PAD, Items.COCOA_BEANS, EItems.WHIFF_OF_MAGIC.get(),
        ...
        KettleRecipeBuilder.of(new ItemStack(EItems.BREW_OF_SPROUTING.get(), 3), 0)
                           .inputs(
                                   EItems.ROWAN_SAPLING.get(), EItems.TONGUE_OF_DOG.get(), EItems.ALDER_SAPLING.get(),
        ...
        KettleRecipeBuilder.of(new ItemStack(EItems.BREW_OF_THE_DEPTHS.get(), 3), 0)
                           .inputs(
                                   Items.LILY_PAD, Items.INK_SAC, EItems.MANDRAKE_ROOT.get(), EItems.TEAR_OF_THE_GODDESS.get(),
        ...
        KettleRecipeBuilder.of(new ItemStack(EItems.BREW_OF_THE_GROTESQUE.get(), 3), 750)
                           .inputs(
                                   EItems.MUTANDIS_EXTREMIS.get(), EItems.MANDRAKE_ROOT.get(), EItems.WATER_ARTICHOKE.get(),
        ...
        KettleRecipeBuilder.of(new ItemStack(EItems.REDSTONE_SOUP.get()), 1000)
                           .inputs(
                                   Items.REDSTONE, EItems.DROP_OF_LUCK.get(), EItems.WOOL_OF_BAT.get(), EItems.TONGUE_OF_DOG.get(),
        ...
        KettleRecipeBuilder.of(new ItemStack(EItems.OTHERWHERE_CHALK.get()), 2000)
        ...
        KettleRecipeBuilder.of(new ItemStack(EItems.NETHER_CHALK.get()), 2000)
                           .inputs(Items.NETHER_WART, Items.BLAZE_POWDER, EItems.RITUAL_CHALK.get())
                           .cookColor(0x54011A)
                           .finalColor(0x9C012F).save(output);
        KettleRecipeBuilder.of(new ItemStack(EItems.DROP_OF_LUCK.get()), 7000)
                           .inputs(
                                   EItems.MANDRAKE_ROOT.get(), Items.NETHER_WART, EItems.TEAR_OF_THE_GODDESS.get(),
                                   EItems.REFINED_EVIL.get(), EItems.MUTANDIS_EXTREMIS.get()
                           )
                           .cookColor(0x004517)
                           .finalColor(0x007527).save(output);
        KettleRecipeBuilder.of(new ItemStack(EItems.MUTANDIS.get(), 6), 0)
                           .inputs(EItems.MANDRAKE_ROOT.get(), EItems.EXHALE_OF_THE_HORNED_ONE.get(), Items.EGG)
                           .cookColor(0x1A4723)
                           .finalColor(0x3E804E).save(output);
        KettleRecipeBuilder.of(new ItemStack(EItems.MUTANDIS_EXTREMIS.get()), 7000)
