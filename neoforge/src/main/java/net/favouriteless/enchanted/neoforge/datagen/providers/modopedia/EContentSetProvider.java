...
public class EContentSetProvider extends ContentSetProvider {
    ...
    public void buildCategories(Provider provider, BookContentOutput output) {
        CategoryBuilder.of("Getting Started")
                       ...
                       .entries(itemPaths(
                               EItems.ARTHANA.get(), EItems.EARMUFFS.get(), EItems.BROOM.get(), EItems.TAGLOCK.get(),
        ...
        CategoryBuilder.of("Altars")
                       ...
                       .entries(
                               blockPath(EBlocks.ALTAR.get()), gettingStartedPath("torch_upgrades"),
        ...
        CategoryBuilder.of("Material Processing")
                       ...
                       .entries(itemPaths(
                               EItems.CLAY_JAR.get(), EItems.BREATH_OF_THE_GODDESS.get(),
        ...
        CategoryBuilder.of("Herbology")
                       ...
                       .entries(blockPaths(
                               EBlocks.BELLADONNA.get(), EBlocks.WATER_ARTICHOKE.get(), EBlocks.MANDRAKE.get(),
        ...
        CategoryBuilder.of("Mutated Plants")
                       ...
                       .entries(blockPaths(
                               EBlocks.ROWAN_SAPLING.get(), EBlocks.HAWTHORN_SAPLING.get(), EBlocks.ALDER_SAPLING.get(),
        ...
        CategoryBuilder.of("Brewing")
                       ...
                       .entries(itemPaths(
                               EItems.MUTANDIS.get(), EItems.MUTANDIS_EXTREMIS.get(), EItems.GOLDEN_CHALK.get(),
        ...
        CategoryBuilder.of("Circle Magic")
                       ...
                       .children(
                               "circle_magic/tutorial", "circle_magic/binding", "circle_magic/creature", "circle_magic/curses",
        ...
        CategoryBuilder.of("Fundamental Theory")
                       ...
                       .entries(itemPaths(
                               EItems.GOLDEN_CHALK.get(), EItems.RITUAL_CHALK.get(), EItems.NETHER_CHALK.get(),
        ...
        CategoryBuilder.of("Curses")
                       ...
                       .entries(ritePaths(
                               "blight", "curse_clumsy", "curse_misfortune", "curse_overheating", "curse_sinking",
        ...
        CategoryBuilder.of("Poppetry")
                       ...
                       .entries(itemPaths(
                               EItems.POPPET_INFUSED.get(), EItems.POPPET_STURDY.get(), EItems.ARMOUR_POPPET.get(),
    ...
    public void buildItemEntries(BookContentOutput output) {
        ...
        craftingEntry(
                output, "Ritual Chalk", FormattedStringBuilder.begin()
        ...
        kettleEntry(
                output, "Golden Chalk", EItems.GOLDEN_CHALK.get(), FormattedStringBuilder.begin()
        ...
        kettleEntry(
                output, "Infernal Chalk", EItems.NETHER_CHALK.get(), FormattedStringBuilder.begin()
        ...
        kettleEntry(
                output, "Otherwhere Chalk", EItems.OTHERWHERE_CHALK.get(), FormattedStringBuilder.begin()
        ...
        craftingEntry(
                output, "Brooms", FormattedStringBuilder.begin()
        ...
        craftingEntry(
                output, "Earmuffs", FormattedStringBuilder.begin()
        ...
        craftingEntry(
                output, "Taglocks", FormattedStringBuilder.begin()
        ...
        craftingEntry(
                output, "Attuned Stones", FormattedStringBuilder.begin()
        ...
        craftingEntry(
                output, "Bone Needles", FormattedStringBuilder.begin()
        ...
        craftingEntry(
                output, "Waystone", FormattedStringBuilder.begin()
        ...
        craftingEntry(
                output, "Circle Talisman", FormattedStringBuilder.begin()
        ...
        kettleEntry(
                output, "Mutandis", EItems.MUTANDIS.get(), FormattedStringBuilder.begin()
        ...
        kettleEntry(
                output, "Mutandis Extremis", EItems.MUTANDIS_EXTREMIS.get(), FormattedStringBuilder.begin()
    ...
    public void buildBrewItemEntries(BookContentOutput output) {
        kettleEntry(
                output, "Brew of Love", EItems.BREW_OF_LOVE.get(), FormattedStringBuilder.begin()
        ...
        kettleEntry(
                output, "Brew of Sprouting", EItems.BREW_OF_SPROUTING.get(), FormattedStringBuilder.begin()
        ...
        kettleEntry(
                output, "Brew of the Depths", EItems.BREW_OF_THE_DEPTHS.get(), FormattedStringBuilder.begin()
        ...
        kettleEntry(
                output, "Brew of the Grotesque", EItems.BREW_OF_THE_GROTESQUE.get(), FormattedStringBuilder.begin()
        ...
        kettleEntry(
                output, "Flying Ointment", EItems.FLYING_OINTMENT.get(), FormattedStringBuilder.begin()
        ...
        kettleEntry(
                output, "Happenstance Oil", EItems.HAPPENSTANCE_OIL.get(), FormattedStringBuilder.begin()
        ...
        kettleEntry(
                output, "Mystic Unguent", EItems.MYSTIC_UNGUENT.get(), FormattedStringBuilder.begin()
        ...
        kettleEntry(
                output, "Redstone Soup", EItems.REDSTONE_SOUP.get(), FormattedStringBuilder.begin()
        ...
        kettleEntry(
                output, "Soul of the World", EItems.SOUL_OF_THE_WORLD.get(), FormattedStringBuilder.begin()
        ...
        kettleEntry(
                output, "Spirit of Otherwhere", EItems.SPIRIT_OF_OTHERWHERE.get(), FormattedStringBuilder.begin()
    ...
    public void buildExtractionItemEntries(BookContentOutput output) {
        cookingEntry(
                output, "Wood Ash", FormattedStringBuilder.begin()
        ...
        cookingEntry(
                output, "Quicklime", FormattedStringBuilder.begin()
        ...
        galleryEntry(
                output, "Breath of the Goddess", EItems.BREATH_OF_THE_GODDESS.get(), FormattedStringBuilder.begin()
        ...
        galleryEntry(
                output, "Demonic Blood", EItems.DEMONIC_BLOOD.get(), FormattedStringBuilder.begin()
        ...
        galleryEntry(
                output, "Diamond Vapour", EItems.DIAMOND_VAPOUR.get(), FormattedStringBuilder.begin()
        ...
        galleryEntry(
                output, "Ender Dew", EItems.ENDER_DEW.get(), FormattedStringBuilder.begin()
        ...
        galleryEntry(
                output, "Horned One's Exhale", EItems.EXHALE_OF_THE_HORNED_ONE.get(), FormattedStringBuilder.begin()
        ...
        galleryEntry(
                output, "Foul Fume", EItems.FOUL_FUME.get(), FormattedStringBuilder.begin()
        ...
        galleryEntry(
                output, "Gypsum", EItems.GYPSUM.get(), FormattedStringBuilder.begin()
        ...
        galleryEntry(
                output, "Hint of Rebirth", EItems.HINT_OF_REBIRTH.get(), FormattedStringBuilder.begin()
        ...
        galleryEntry(
                output, "Odour of Purity", EItems.ODOUR_OF_PURITY.get(), FormattedStringBuilder.begin()
        ...
        galleryEntry(
                output, "Oil of Vitriol", EItems.OIL_OF_VITRIOL.get(), FormattedStringBuilder.begin()
        ...
        galleryEntry(
                output, "Reek of Misfortune", EItems.REEK_OF_MISFORTUNE.get(), FormattedStringBuilder.begin()
        ...
        galleryEntry(
                output, "Refined Evil", EItems.REFINED_EVIL.get(), FormattedStringBuilder.begin()
        ...
        galleryEntry(
                output, "Tear of the Goddess", EItems.TEAR_OF_THE_GODDESS.get(), FormattedStringBuilder.begin()
        ...
        galleryEntry(
                output, "Whiff of Magic", EItems.WHIFF_OF_MAGIC.get(), FormattedStringBuilder.begin()
    ...
    public void buildBlockEntries(BookContentOutput output) {
        ...
        EntryBuilder.of("Creating an Altar")
                    ...
                    .page(
                            HeaderedTextBuilder.of(
                                    "Creating an Altar", FormattedStringBuilder.begin()
                    ...
                    .page(
                            HeaderedTextBuilder.of(
                                    "Upgrades", FormattedStringBuilder.begin()
        ...
        EntryBuilder.of("Distillation")
                    ...
                    .page(HeaderedTextBuilder.of(
                                  "Distillation", FormattedStringBuilder.begin()
        ...
        EntryBuilder.of("Spinning")
                    ...
                    .page(HeaderedTextBuilder.of(
                            "Spinning", FormattedStringBuilder.begin()
        ...
        EntryBuilder.of("Poppet Shelf")
                    ...
                    .page(HeaderedTextBuilder.of(
                            "Poppet Shelf", FormattedStringBuilder.begin()
        ...
        EntryBuilder.of("Fume Collection")
                    ...
                    .page(HeaderedTextBuilder.of(
                                  "Fume Collection", FormattedStringBuilder.begin()
                    ...
                    .page(BlockPageBuilder.of(
                                  FormattedStringBuilder.begin()
    ...
    public void buildHerbologyBlockEntries(BookContentOutput output) {
        blockEntry(
                output, "Belladonna", FormattedStringBuilder.begin()
        ...
        blockEntry(
                output, "Garlic", FormattedStringBuilder.begin()
        ...
        blockEntry(
                output, "Mandrakes", FormattedStringBuilder.begin()
        ...
        blockEntry(
                output, "Snowbell", FormattedStringBuilder.begin()
        ...
        blockEntry(
                output, "Water Artichoke", FormattedStringBuilder.begin()
        ...
        blockEntry(
                output, "Wolfsbane", FormattedStringBuilder.begin()
        ...
        mutatedEntry(
                output, "Glint Weed", FormattedStringBuilder.begin()
        ...
        mutatedEntry(
                output, "Ember Moss", FormattedStringBuilder.begin()
        ...
        mutatedEntry(
                output, "Spanish Moss", FormattedStringBuilder.begin()
        ...
        mutatedEntry(
                output, "Blood Poppy", FormattedStringBuilder.begin()
        ...
        EntryBuilder.of("Alder Trees")
                    ...
                    .assignedItems(
                            EItems.ALDER_SAPLING.get(), EItems.ALDER_LOG.get(), EItems.STRIPPED_ALDER_LOG.get(),
                    ...
                    .page(
                            HeaderedTextBuilder.of(
                                    "Alder Trees", FormattedStringBuilder.begin()
        ...
        EntryBuilder.of("Hawthorn Trees")
                    ...
                    .assignedItems(
                            EItems.HAWTHORN_SAPLING.get(), EItems.HAWTHORN_LOG.get(), EItems.STRIPPED_HAWTHORN_LOG.get(),
                    ...
                    .page(
                            HeaderedTextBuilder.of(
                                    "Hawthorn Trees", FormattedStringBuilder.begin()
        ...
        EntryBuilder.of("Rowan Trees")
                    ...
                    .assignedItems(
                            EItems.ROWAN_BERRIES.get(), EItems.ROWAN_SAPLING.get(), EItems.ROWAN_LOG.get(),
                    ...
                    .page(
                            HeaderedTextBuilder.of(
                                    "Rowan Trees", FormattedStringBuilder.begin()
    ...
    public void buildGettingStartedEntries(BookContentOutput output) {
        EntryBuilder.of("Chalice Upgrades")
                    ...
                    .page(
                            HeaderedTextBuilder.of(
                                    "Chalices", FormattedStringBuilder.begin()
        ...
        EntryBuilder.of("Skull Upgrades")
                    ...
                    .page(HeaderedTextBuilder.of(
                                  "Skulls", FormattedStringBuilder.begin()
    ...
    public void buildBrewingEntries(BookContentOutput output) {
        EntryBuilder.of("Creating Brews")
                    .icon(EItems.WITCH_CAULDRON.get().getDefaultInstance())
                    .page(HeaderedTextBuilder.of(
                                  "Brews and Potions", FormattedStringBuilder.begin()
                    ...
                    .page(HeaderedTextBuilder.of(
                                  "Adding Ingredients", FormattedStringBuilder.begin()
                    ...
                    .page(HeaderedTextBuilder.of(
                                  "Spoiled Brews", FormattedStringBuilder.begin()
    ...
    public void buildHerbologyEntries(BookContentOutput output) {
        EntryBuilder.of("Mutations")
                    ...
                    .page(HeaderedTextBuilder.of(
                            "Mutations", FormattedStringBuilder.begin()
                    ...
                    .page(
                            HeaderedTextBuilder.of(
                                    "Mutandis", FormattedStringBuilder.begin()
                    ...
                    .page(HeaderedTextBuilder.of(
                            "Mutagens", FormattedStringBuilder.begin()
    ...
    public void buildCircleMagicEntries(BookContentOutput output) {
        EntryBuilder.of("Performing Rites")
                    ...
                    .page(
                            HeaderedTextBuilder.of(
                                    "Performing Rites", FormattedStringBuilder.begin()
                    ...
                    .page(
                            HeaderedTextBuilder.of(
                                    "Heart Glyphs", FormattedStringBuilder.begin()
                    ...
                    .page(HeaderedTextBuilder.of(
                                  "Glyphs and Foci", FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Charging Stones", EItems.ATTUNED_STONE_CHARGED.get(), EItems.ATTUNED_STONE_CHARGED.get(), FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Broomsticks", EItems.ENCHANTED_BROOMSTICK.get(), EItems.ENCHANTED_BROOMSTICK.get(), FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Familiars", EItems.ARTHANA.get(), FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Talisman", EItems.CIRCLE_TALISMAN.get(), FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Waystone", EItems.BOUND_WAYSTONE.get(), EItems.BOUND_WAYSTONE.get(), FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Blooded Waystone", EItems.BLOODED_WAYSTONE.get(), EItems.BLOODED_WAYSTONE.get(), FormattedStringBuilder.begin()
        ...
        EntryBuilder.of("Casting Curses")
                    .icon(Items.WITHER_ROSE.getDefaultInstance())
                    .page(HeaderedTextBuilder.of(
                            "Casting Curses", FormattedStringBuilder.begin()
                    ...
                    .page(HeaderedTextBuilder.of(
                            "Removing Curses", FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Blight", Items.SPIDER_EYE, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Clumsy", Items.SLIME_BALL, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Misfortune", Items.ENDER_EYE, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Overheating", Items.BLAZE_POWDER, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Sinking", Items.WATER_BUCKET, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Cleanse Clumsy", Items.SLIME_BALL, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Cleanse Misfortune", Items.ENDER_EYE, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Cleanse Overheating", Items.BLAZE_POWDER, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Cleanse Sinking", Items.WATER_BUCKET, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Broiling", Items.BEEF, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Fertility", Items.EMERALD, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Forest", Items.OAK_SAPLING, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Sky's Wrath", Items.LIGHTNING_ROD, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Total Eclipse", Items.CLOCK, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Transpose Iron", Items.RAW_IRON, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Imprisonment", Items.IRON_BARS, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Protection", Items.SHIELD, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Temporary Protection", Items.SHULKER_SHELL, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Sanctity", Items.FEATHER, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Summon Entity", Items.CHORUS_FRUIT, FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Summon Familiar", EItems.ARTHANA.get(), FormattedStringBuilder.begin()
        ...
        riteEntry(
                output, "Transpose Caster", Items.ENDER_PEARL, FormattedStringBuilder.begin()
    ...
    public void buildPoppetryEntries(BookContentOutput output) {
        EntryBuilder.of("Poppet Theory")
                    ...
                    .page(HeaderedTextBuilder.of(
                            "Poppetry", FormattedStringBuilder.begin()
                    ...
                    .page(
                            HeaderedTextBuilder.of(
                                    "Creating Poppets", FormattedStringBuilder.begin()
        ...
        spinningEntry(
                output, "Sturdy Poppets", FormattedStringBuilder.begin()
        ...
        spinningEntry(
                output, "Infused Poppets", FormattedStringBuilder.begin()
        ...
        spinningEntry(
                output, "Armour", FormattedStringBuilder.begin()
        ...
        spinningEntry(
                output, "Earth", FormattedStringBuilder.begin()
        ...
        spinningEntry(
                output, "Fire", FormattedStringBuilder.begin()
        ...
        spinningEntry(
                output, "Hunger", FormattedStringBuilder.begin()
        ...
        spinningEntry(
                output, "Magic", FormattedStringBuilder.begin()
        ...
        spinningEntry(
                output, "Tool", FormattedStringBuilder.begin()
        ...
        spinningEntry(
                output, "Void", FormattedStringBuilder.begin()
        ...
        spinningEntry(
                output, "Voodoo", FormattedStringBuilder.begin()
        ...
        spinningEntry(
                output, "Voodoo Protection", FormattedStringBuilder.begin()
        ...
        spinningEntry(
                output, "Water", FormattedStringBuilder.begin()
