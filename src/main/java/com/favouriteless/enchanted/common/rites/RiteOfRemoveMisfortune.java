...
public class RiteOfRemoveMisfortune extends AbstractRemoveCurseRite {

    public RiteOfRemoveMisfortune() {
        super(EnchantedRiteTypes.REMOVE_MISFORTUNE.get(), 2000, 0, EnchantedCurseTypes.MISFORTUNE.get()); // Power, power per tick, curse type
